...
/**
 * Celo mainnet:
 *   forge script script/DeployV2.s.sol:DeployV2 --rpc-url celo --broadcast --verify
 *
...
contract DeployV2 is Script {
    ...
    function run() external {
        ...
        RemessoExecutorV2 exec =
            new RemessoExecutorV2(USDT, CNGN, SWAP_ROUTER_02, executor, POOL_FEE);
        vm.stopBroadcast();

        console2.log("RemessoExecutorV2:", address(exec));
